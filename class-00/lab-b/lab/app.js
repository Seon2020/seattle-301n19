...
// "this" is the joe student object that was created earlier when we did "new Student".
// 2. What is "this" when joe.scopeArrow() is invoked?
// this is now referring to the window object.  
// 3. Explain why "this" is different when an arrow function is used.
// with an arrow function, "this" refers to enclosing scope. In this case, since there is not a non-arrow function surrounding it, this is now the window object.
